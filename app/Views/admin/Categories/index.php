<h1><em>Administrer Les categorie</em></h1><br>
  ...
  <a href="?p=admin.categories.add" class="btn btn-outline-success">Ajouter des nouveau categories</a><br><br>
   ...
   <table class="table table-hover table-bordered">
        ...
        <?php foreach ($categories as $categorie):?>
           ...
           <tr>
              ...
              <td class="text-center">
                <a href="?p=admin.categories.edit&id=<?= $categorie->id ?>" class="btn btn-outline-warning">Editer</a>
      ...
      <ul class="pagination justify-content-center">
        <?php for($i=0;$i<$nbpage;$i++) :?>
         <li class="page-item"><a  class="page-link" href="?p=admin.categories.index&n=<?=$i?>"> <?=$i+1?> </a></li>
        <?php endfor;?>
      </ul>
